...
import { CustomerService, ICustomerModel } from 'src/app/services/admin/customer/customer.service';
...
export class CustomerListingComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private customerApiService: CustomerService , private countryApiService: CountryService, private roleService: RoleService, private cdr: ChangeDetectorRef) { }
